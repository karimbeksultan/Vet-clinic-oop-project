...
public class Pet implements Servable {
    ...
    public void setName(String name) throws InvalidInputException {
        if (!Validating.isValidStr(name)) throw new InvalidInputException("model.Pet name is invalid");
        this.name = name;
    }

    public void setSpecies(String species) throws InvalidInputException {
        if (!Validating.isValidStr(species)) throw new InvalidInputException("Species is invalid");
        this.species = species;
    }

    public void setAge(int age) throws InvalidInputException {
        if (age < 0 || age > 100) throw new InvalidInputException("Age must be 0–100");
        this.age = age;
    }
    ...
    public String toString() {
        return name + " (" + species + ", " + age + " yo, " + gender + ", vaccinated=" + vaccinated + ")";
    }
}
